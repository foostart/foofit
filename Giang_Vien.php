...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="vi">
    <head>
        ...
        <link href="../foofit/147/css/147.css" rel="stylesheet" type="text/css"/> 
        <link href="../foofit/146/css/146.css" rel="stylesheet" type="text/css"/> 
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <?php include '../foofit/147/147-content.php'; ?>
                    </div> 
                    <div class="col-md-8 col-sm-12 col-xs-12">
                        <?php include '../foofit/146/146-content.php'; ?>
                    </div> 
                </div>
            </div> 
