...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="vi">
    <head>
        ...
        <link href="../foofit/135/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
        <link href="../foofit/var/page.css" rel="stylesheet" type="text/css"/>
        <link href="../foofit/133/css/133.css" rel="stylesheet" type="text/css"/> 
        <link href="../foofit/179/css/179.css" rel="stylesheet" type="text/css"/> 
            ...
            <div class="container main">
                <div class="row">
                    <div class="col-md-8 col-sm-12 col-xs-12">
                        <?php include '../foofit/179/179-content.php'; ?>
                        <?php include '../foofit/158/158-content.php'; ?>
                    </div> 
