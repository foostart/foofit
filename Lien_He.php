...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="vi">
    <head>
        ...
        <link href="../foofit/163/css/163.css" rel="stylesheet" type="text/css"/> 
        <link href="../foofit/164/css/164.css" rel="stylesheet" type="text/css"/> 
        ...
        <div id="page">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <?php include '../foofit/164/164-content.php'; ?>
                    </div> 
                </div>
            </div> 
